...
const Feed = () => {
  ...
  return (
    <Box sx={{ borderRight:'2px solid red' , borderLeft:'2px solid red' , height:'100vh!important'}}>
      <HeaderStyle>
        <Typography fontWeight="bold">Acceuil</Typography>
        <StarPurple500 />
      </HeaderStyle>
      <Box variant="div" sx={{ borderBottom: "1.5px solid red" }}>
          ...
          >
            <div className="d-flex">
              ...
              <input
                type="file"
                value={gifPost}
                onChange={(e) => setGifPost(e.target.value)}
                name="Addgif"
                id="Addgif"
                className="d-none"
              />
            ...
            <button
              type="submit"
              className="bg-primary text-white rounded border-0 p-1 text-capitalize"
            >
              tweeter
            </button>
          </Stack>
